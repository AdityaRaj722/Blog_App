...
<body style="font-family: Open Sans, sans-serif">
    <section class="px-6 py-8">
        <nav class="md:flex md:justify-between md:items-center">
            <div>
                <a href="/" class="text-blue-500 group inline-flex items-center rounded-md bg-white text-base font-bold hover:text-blue-900 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2">My Blog App</a>
            </div>
            ...
            <div class="mt-8 md:mt-0 flex items-center">
                ...
                <x-dropdown>
                    ...
                    @endcan
                        ...
                        <form method="POST" id="logout-form" action="/logout" class="text-xs font-semibold text-blue-500 ml-6" class="hidden">
                            @csrf
                        </form>
                </x-dropdown>
                @else
        ...
        <footer id="newsletter" class="bg-gray-100 border border-black border-opacity-5 rounded-xl text-center py-16 px-10 mt-16">
            {{-- comment: add your business logo here --}}
            <h1 class="font-bold">Your cool</h1>
            <h1 class="font-bold">Business</h1>
            <h1 class="font-bold">Logo Here</h1>
            {{-- End comment --}}
